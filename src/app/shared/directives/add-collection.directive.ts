...
export class AddCollectionDirective {
  ...
  addMovies(): void {
    ...
    this.movies.forEach(movie => {
      prom.push(this.movieService.getMovie(movie.id, new MovieDetailConfig(false, false, false, false, false, false, 'fr'), false));
      prom.push(this.movieService.getMovie(movie.id, new MovieDetailConfig(false, false, false, false, false, false, 'en'), false));
