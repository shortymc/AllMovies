...
export class AddCollectionDirective {
  ...
  addMovies(): void {
    ...
    this.movies.forEach(movie => {
      prom.push(this.movieService.getMovie(movie.id, false, false, false, false, false, false, 'fr'));
      prom.push(this.movieService.getMovie(movie.id, false, false, false, false, false, false, 'en'));
